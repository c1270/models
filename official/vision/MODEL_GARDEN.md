...
* Training details:
  * pre-trained_Models finetuned from [ImageNet](https://www.image-net.org/) pre-trained
    checkpoints adopt the 12 or 36 epochs schedule. pre-trained_Models trained from scratch
